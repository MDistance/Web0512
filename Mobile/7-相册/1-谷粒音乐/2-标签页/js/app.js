...
(function () {
    ...
    var swiperWrapper = floor.querySelector('.swiper-wrapper');
    //幻灯片功能
    ...
    container.addEventListener('touchend', function () {
        ...
        //获取 当前包裹元素的 translateX
        var translateX = transformCSS(swiperWrapper, 'translateX');

        //按照计算对象的index
        var index = -Math.round(translateX / container.offsetWidth);
        //根据 index 切换底部边框的位置
        //计算
        var translateX = index * navItems[0].offsetWidth;
        //设置
