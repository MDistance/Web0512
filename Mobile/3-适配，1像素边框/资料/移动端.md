...
移动端设备的屏幕尺寸繁多，要想让页面的呈现统一，需要对不同尺寸的设备进行适配。适配的常见方法：

* viewport 适配

* <div style="color:red">rem 适配</div>
...
- <http://c.m.163.com/CreditMarket/default.html>
...
viewport.setAttribute('content', 'initial-scale='+1/dpr + ',user-scalable=no');
```
...
- 全局安装 lessc
  - `npm install less -g`
- 启动 webstorm
- webstorm 下 File -> settings -> 搜索 File Watcher ->  + 选择less -> OK 确定👌
